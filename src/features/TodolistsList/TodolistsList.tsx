...
import { FilterValuesType, todolistsActions, todosThanks } from "features/TodolistsList/todolists.reducer"
...
export const TodolistsList: React.FC<PropsType> = ({ demo = false }) => {
  ...
  useEffect(() => {
    ...
    dispatch(todosThanks.fetchTodolists())
  }, [dispatch])
  ...
  const removeTodolist = useCallback(
    function (id: string) {
      dispatch(todosThanks.removeTodolist(id))
    },
    [dispatch],
  )
  ...
  const changeTodolistTitle = useCallback(
    function (id: string, title: string) {
      dispatch(todosThanks.changeTodolistTitle({ id, title }))
    },
    [dispatch],
  )
  ...
  const addTodolist = useCallback(
    (title: string) => {
      dispatch(todosThanks.addTodolist(title))
    },
    [dispatch],
  )
